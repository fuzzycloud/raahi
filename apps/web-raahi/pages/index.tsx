...
<button onClick={() => router.replace('/searchFlight')} className="px-10 bg-green-500 hover:bg-grey text-grey-darkest font-bold py-2 px-4 rounded inline-flex items-center">
