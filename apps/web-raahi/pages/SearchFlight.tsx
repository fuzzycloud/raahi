        ...
        <h1 className="text-gray-600 font-bold md:text-2xl text-xl">Search Flights</h1>
          ...
          <div className="px-4 py-5 bg-white sm:p-6"> */}
                      ...
                      <div className="col-span-12 sm:col-span-12">
                        ...
                        <button onClick={() => router.replace('/Flights')}className=" mt-10 bg-transparent hover:bg-green-500 text-blue-dark font-semibold hover:text-white py-2 px-4 border border-blue hover:border-transparent rounded">
    Search
</button>
                      </div>
                    </div>
