    ...
    <div>
            ...
            <div className="w-full text-center">
              ...
              >
                ...
                <button
                  ...
                  className="px-10 mr-5 bg-green-500 hover:bg-grey text-grey-darkest font-bold py-2 px-4 rounded inline-flex items-center"
                >
                  <svg
                ...
                <button
                  ...
                  className="px-10 bg-green-500 hover:bg-grey text-grey-darkest font-bold py-2 px-4 rounded inline-flex items-center"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
      ...
      <section>
        <div className="antialiased  font-sans ">
          <h3 className="text-center text-3xl text-bold">Popular Flights</h3>
