...
export default function Index() {
  ...
  return (
    <div className=" ">
        ...
        <div className="hero bg-green-100 min-h-screen bg-base-200">
          <div className="hero-content flex-col lg:flex-row-reverse">
            ...
            <div>
              ...
              <button
                onClick={() => router.replace('/SearchHotel')}
                className="px-10 mr-5 text-white bg-green-500 hover:bg-grey text-grey-darkest font-bold py-2 px-4 rounded inline-flex items-center"
              >
                <svg
              ...
              <button
                onClick={() => router.replace('/SearchFlight')}
                className="px-10 text-white bg-green-500 hover:bg-grey text-grey-darkest font-bold py-2 px-4 rounded inline-flex items-center"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
      ...
      <section>
        <div className="antialiased bg-green-100 text-gray-900 font-sans ">
